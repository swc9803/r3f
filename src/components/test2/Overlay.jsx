    ...
    <>
      ...
      >
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 flex-1 flex items-center justify-between p-4">
          <button
            onClick={() =>
              setSlide((prev) => (prev < modelInfo.length - 1 ? prev + 1 : 0))
            }
            disabled={!visible}
          ...
          >
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-10 h-10 hover:opacity-60 transition-opacity pointer-events-none"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="bg-gradient-to-t from-white/90 pt-20 pb-10 p-4 flex items-center flex-col text-center">
          <h1 className="text-5xl font-extrabold">{modelInfo[displaySlide].name}</h1>
          <p className="text-opacity-60 italic">{modelInfo[displaySlide].description}</p>
          <div className="flex items-center gap-12 mt-10">
            <div className="flex flex-col items-center">
              <div className="flex gap-2 items-center">
                ...
                <p className="font-semibold text-3xl">
                  ${modelInfo[displaySlide].price.toLocaleString()}
                </p>
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="flex items-center gap-2">
                ...
                <p className="font-semibold text-3xl">
                  {modelInfo[displaySlide].range}km
                </p>
              </div>

...
export const foodItems = [
  ...
  },
  {
    ...
    name: 'Octopus Nigiri',
    description: 'A type of sushi made of thinly sliced raw octopus and vinegared rice.',
  },
  {
    model: 'Food_SalmonNigiri',
    name: 'Salmon Nigiri',
    description: 'A type of sushi made of thinly sliced raw salmon and vinegared rice.',
  },
  {
  ...
  return (
    <>
      <div className="flex-1 w-full flex items-center justify-between">
        <svg
          onClick={() => setFoodIndex((i) => (i > 0 ? i - 1 : foodItems.length - 1))}
      ...
      <div className="mb-10">
        <h3 className="text-2xl font-bold font-serif">{foodItems[foodIndex].name}</h3>
